...
CONTEXT_PROCESSORS = [
    ...
    "wawo.home.context_processors.settings",
...
WAGTAIL_SITE_NAME = 'wawo'
WAGTAIL_APPEND_SLASH = 'settings.APPEND_SLASH'
WAGTAILADMIN_NOTIFICATION_FROM_EMAIL = 'wagtail@wawo.com'
